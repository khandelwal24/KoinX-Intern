...
console.log('Hey Brookes',coin);
  ...
  return (
    ...
    {/* we can also use this above commentied grid div to represent this into grid fromate instead of this flex */}
    <marquee>
   
    <div className='flex relative inset-0 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-1 w-full gap-5 justify-center'>
        {coin?.slice(0,10)?.map((v,i)=>{
            return(  
                <div key={i}>
